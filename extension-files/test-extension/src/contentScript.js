...
// ==========================================
// OFFERLINE THEMES
// Copy of popup themes - modify colors/sizes as needed
// ==========================================

const templateOfferline = {
    // Same structure as 'template' - change values as needed
    fontUrl: 'https://fonts.googleapis.com/css2?family=Barlow:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap',
    fontFamily: "'Barlow', sans-serif",
    popupBg: "#192E34",
    popupShadow: "",
...
const darkThemeOfferline = {
    // Same structure as 'darkTheme' - change values as needed
    fontUrl: 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300..900;1,300..900&display=swap',
    fontFamily: '"Rubik", sans-serif',
    popupBg: "#15171F",
    popupShadow: "0px 6px 20px 0px rgba(0, 0, 0, 0.10), 0px 1px 8px 0px rgba(0, 0, 0, 0.06)",
...
const lightThemeOfferline = {
    // Same structure as 'lightTheme' - change values as needed
    popupBg: "#FFFFFF",
    popupShadow: "0px 6px 20px 0px rgba(0, 0, 0, 0.10), 0px 1px 8px 0px rgba(0, 0, 0, 0.06)",
    primaryBtnBg: "#4B6DDE",
    primaryBtnFC: "#FFFFFF",
...
bringInitContentScript({
    ...
    text: 'upper',
    switchWallet: true,
    // Regular popup themes
    lightTheme: template,
    darkTheme: dark
    // OfferLine will apply platform-specific styles dynamically inside the iframe
});
